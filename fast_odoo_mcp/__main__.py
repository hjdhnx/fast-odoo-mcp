"""Entry point for the fast-odoo-mcp package.
...
Optional environment variables:
  ...
  ODOO_MCP_TRANSPORT       Transport type: stdio, sse, or streamable-http (default: stdio)
  ...
  ODOO_MCP_DISABLED_TOOLS  Comma-separated list of tools to disable (e.g. "create_record,update_record,delete_record")
                            Useful for read-only deployments. Available tool names:
                            create_record, update_record, delete_record,
                            create_records, update_records, delete_records

For more information, visit: https://github.com/hjdhnx/fast-odoo-mcp""",
    )
    ...
    parser.add_argument(
        "--host",
        default=None,
        help="Server host for HTTP transports (defaults to ODOO_MCP_HOST env var or requires explicit setting for security)",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Server port for HTTP transports (defaults to ODOO_MCP_PORT env var or requires explicit setting for security)",
    )
