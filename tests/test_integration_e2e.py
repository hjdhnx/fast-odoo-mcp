...
from fast_odoo_mcp.access_control import AccessController
from fast_odoo_mcp.config import OdooConfig
from fast_odoo_mcp.error_handling import NotFoundError, ValidationError
from fast_odoo_mcp.error_handling import PermissionError as MCPPermissionError
from fast_odoo_mcp.odoo_connection import OdooConnection
from fast_odoo_mcp.resources import OdooResourceHandler
...
class TestServerLifecycle:
    ...
    def test_uvx_server_startup(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "fast_odoo_mcp", "--help"],
            capture_output=True,
            text=True,
            timeout=10,
        )
