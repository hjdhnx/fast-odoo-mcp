...
from fast_odoo_mcp.access_control import AccessControlError
from fast_odoo_mcp.error_handling import ValidationError
from fast_odoo_mcp.odoo_connection import OdooConnectionError
from fast_odoo_mcp.tools import OdooToolHandler, register_tools
...
class TestWriteToolsIntegration:
    ...
    async def test_create_update_delete_cycle(self, real_config, real_tool_handler):
        ...
        try:
            ...
            # Verify deletion
            from fast_odoo_mcp.tools import ValidationError
