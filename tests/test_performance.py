...
from fast_odoo_mcp.performance import (
    Cache,
    CacheEntry,
    ConnectionPool,
    PerformanceManager,
...
class TestConnectionPool:
    ...
    @patch("fast_odoo_mcp.performance.ServerProxy")
    ...
    def test_odoo_transport_sends_database_header(self, mock_config):
        ...
        from fast_odoo_mcp.performance import OdooTransport
    ...
    def test_connection_pool_clear(self, mock_config):
        ...
        with patch("fast_odoo_mcp.performance.ServerProxy"):
            pool.get_connection("/endpoint1")
            pool.get_connection("/endpoint2")
